...
export function validateData(file: MediaFile) {
  ...
  if (season  === undefined && type === "show") errors.push(VALIDATION_ERROR.season);
  if (episode === undefined && type === "show") errors.push(VALIDATION_ERROR.episode);
  if (year === undefined && type === "movie") errors.push(VALIDATION_ERROR.year);
